...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 23 02:29:21 2024
...
from Networks_Gpu import Actor, Critic, clip_grad
...
wb = 0  # Do you want to log your data to weighs and biases? True, activate weigths and biases
    ...
    def train(self,episodes,batch_size,timesteps):
        ...
        for e in range(episodes):
            ...
            for t in range(timesteps): 
                ...
                with torch.no_grad():
                    next_action, next_log_prob = self.actor.sample(batch_next_states)
                ...
                act, log_probs = self.actor.sample(batch_states)
...
if __name__ == "__main__":
    ...
    if wb and connect:
        ...
        project="Diffusion Pendulum",
        name = "Vanilla Soft Actor Critic",
